...
else if (window.location.pathname==='/data-source/')
{
window.ed.place='data-source';
...
window.ed.charts = {};
	...
	switch (window.ed.place_type)
	{
		...
		case "country":
			...
			// window.ed.charts['country_graph_area_daily'] = Object.assign({}, {}, window.ed.chart_templates['country_graph_area_daily']);
