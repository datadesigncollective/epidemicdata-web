                ...
                <b-col class="main_bar" cols="10">
                    <div :id="'google_chart_'+chart_key+'_container'">
                        <div :id="'google_chart_'+chart_key+'_outer'" style="position: relative;">
                            <div :id="'google_chart_'+chart_key+''" v-html="'google_chart_'+chart_key+''" style="width: 100%; height: 600px; -outline: 1px solid lightgreen;" ></div>
                            <div :id="'google_chart_'+chart_key+'_overlay'" style="position: absolute; top: 0px; left: 0px; right: 0px; text-align: center;">
