...
<template>
    <b-row class="image_generating" v-show="chart.image_generating !== 0">
        <b-col class="main_bar" cols="10" style="position: absolute; top: 0; left: -4500px; background-color: white;">
            <!--<div>
            ...
            <div v-show="chart.image_generating > 1">
                ...
                <div :id="'google_chart_'+chart_key+'_canvas_container'"></div>
