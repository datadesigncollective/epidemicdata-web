            ...
            <div id="layoutSidenav_content">
                <main>
                        ...
                        <div style="max-width: 800px; padding: 20px;">
                            <div class="row">
                                <template v-for="(continent, continent_index) in window.ed.continents">
                                    <div class="col">
                                        <template v-if="typeof(continent['countries'])!=='undefined'">
                    ...
                    <template v-else>
                        ...
                        <template v-if="(!window.ed.is_chart) && (window.ed.place_type=='region')">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            ...
                            <div>
                                <a href="/about/">About</a> &nbsp; <a class="" href="https://www.facebook.com/epidemicdata" target="_blank" style=" display: inline-block; padding: 12px 0px;"><i class="fa fa-facebook white-text mr-4"> </i></a>
                            </div>
                        </div>
                    </div>
                </footer>
