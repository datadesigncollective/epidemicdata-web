...
<template>
    <div>
        <nav class="sb-topnav navbar -navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="/"><img src="/_web_elements/i/epidemicdata-logo.png" style="max-width: 230px;" /></a><!--<button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
        >-->
            <!-- Navbar-->
                ...
                <main>
                    ...
                    <div class="page_charts">
                        <template v-for="(chart, chart_key) in charts">
                            <div :id="'page_chart_container_'+chart_key">
